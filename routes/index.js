...
router.get('/', function (req, res) { 
    res.render('index', { title: 'monitor App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'monitor App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'monitor App Login', user : req.user }); 
}); 
